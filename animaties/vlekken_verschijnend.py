...
def render_spots_frame(frame_number, spot_positions, background_size):
    """
...
def create_spots_appearing_animation(output_filename=None, seed=None):
    """
    ...
    for frame_num in range(TOTAL_FRAMES):
        ...
        spots_overlay = render_spots_frame(frame_num, spot_positions, background.size)
